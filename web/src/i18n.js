...
export const I18N = {
  en: {
    ...
    mode2_num: 'Mode 2',
    mode2_title: 'Pokémon → Similar Pokémon',
    mode1_lede:
    ...
    mode2_lede:
      'Pick Pokémon you already have. We’ll rank other Pokémon that share similar favorites, and warn you when Ideal Habitats clash.',
    picker_heading: 'Choose Pokémon',
    results_heading: 'Suggested items',
    mode2_results_heading: 'Similar Pokémon',
    ...
    mode2_results_empty:
      'Select at least one Pokémon to see others with similar favorites.',
    mode2_results_filtered:
      'No Pokémon reach the minimum match count. Try lowering the filter.',
    score_label: 'matches',
    liked_by: 'Liked by',
    similar_to: 'Shares favorites with',
  ...
  ja: {
    ...
    mode2_num: 'モード2',
    mode2_title: 'ポケモン → 似た好み',
    mode1_lede:
      '同じ場所に住ませたいポケモンを選ぶと、好みに合うアイテムを優先度つきで表示します。理想の環境がぶつかる場合は警告します。',
    mode2_lede:
      '手元のポケモンを選ぶと、好みが似ているほかのポケモンを優先度つきで表示します。理想の環境がぶつかる場合は警告します。',
    picker_heading: 'ポケモンを選ぶ',
    results_heading: 'おすすめアイテム',
    mode2_results_heading: '好みが似ているポケモン',
    ...
    mode2_results_empty:
      'ポケモンを選ぶと、好みが似ているポケモンが表示されます。',
    mode2_results_filtered:
      '最低一致数に達するポケモンがありません。フィルターを下げてみてください。',
    score_label: '一致',
    liked_by: '好きなポケモン',
    similar_to: '好みが重なるポケモン',
  ...
  zh_tw: {
    ...
    mode1_title: '寶可夢 → 道具',
    mode2_num: '模式 2',
    mode2_title: '寶可夢 → 相似喜好',
    mode1_lede:
      '選擇想放在同一生活區的寶可夢，依喜好排出適合的道具；若理想環境互相衝突會顯示警告。',
    mode2_lede:
      '選擇已有的寶可夢，依共同喜好排出相似的其他寶可夢；若理想環境互相衝突會顯示警告。',
    picker_heading: '選擇寶可夢',
    results_heading: '推薦道具',
    mode2_results_heading: '喜好相似的寶可夢',
    search_placeholder: '依名稱、環境或喜好搜尋…',
    clear: '清除',
    min_score: '最低相符數',
    results_empty: '請先選擇至少一隻寶可夢。',
    results_filtered: '沒有達到最低相符數的道具，請調低篩選條件。',
    mode2_results_empty: '請先選擇至少一隻寶可夢，以查看喜好相似的其他寶可夢。',
    mode2_results_filtered: '沒有達到最低相符數的寶可夢，請調低篩選條件。',
    score_label: '相符',
    liked_by: '喜歡的寶可夢',
    similar_to: '喜好重疊的寶可夢',
